...
export function WhiskerLogo({ size = 'md', showText = true, className = '' }: WhiskerLogoProps) {
  console.log('WhiskerLogo rendering with size:', size, 'showText:', showText);
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      <div className="relative">
        <img 
          src="/IMG_3906_1752586079724.png"
          alt="WhiskerSwap Custom Logo"
          className="object-contain"
          style={{ width: icon, height: icon }}
          onLoad={() => console.log('Custom logo loaded successfully')}
          onError={(e) => {
            console.error('Custom logo failed to load, falling back to whisker-logo.png');
