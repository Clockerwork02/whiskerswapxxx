  ...
  return (
    <>
      <Button
        ...
        className="h-8 px-3 text-xs text-teal-400 hover:bg-teal-400/10 hover:text-teal-400 border-none cursor-pointer z-10 relative"
      >
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-md bg-slate-800/95 backdrop-blur-md border-teal-400/30 text-white">
          <DialogHeader>
          ...
          <div className="space-y-4">
            ...
            {detectedToken && (
              <div className="bg-slate-800/50 border border-teal-400/30 rounded-lg p-3 space-y-2">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-teal-400 font-medium">{detectedToken.symbol}</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-teal-400 to-cyan-400 hover:from-teal-400/80 hover:to-cyan-400/80 text-black font-semibold"
              >
